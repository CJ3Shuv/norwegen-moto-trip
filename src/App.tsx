  ...
  return (
    <div className="app">
      <aside className="sidebar">
        ...
        <p className="footer-note">Kartendaten © OpenStreetMap-Mitwirkende</p>
      </aside>
      ...
      <div className="map-area">
        <MapContainer center={DEFAULT_CENTER} zoom={DEFAULT_ZOOM} scrollWheelZoom>
          ...
          {polylinePositions.length > 1 && (
            <Polyline positions={polylinePositions} pathOptions={{ color: '#aa3bff', weight: 4 }} />
          )}
          {waypoints.map((w, i) => (
            <Marker
              key={w.id}
